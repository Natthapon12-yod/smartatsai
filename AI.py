...
4) คำนวณตามขั้นบันไดทุกครั้งและควณให้ถูกด้วย
5) ค่าบริการเช็คให้ถูกว่าอยู่ส่วนไหนนำมาคำนวณให้ถูก

ข้อมูลอัตราค่าไฟฟ้า (มกราคม - เมษายน 2569):
* ค่า Ft: 0.0972 บาท/หน่วย นำไป + หลังจาก ค่าไฟฟ้าฐาน+ค่าภาษีมูลค่าเพิ่ม 7% แล้วเท่านั้น
* ภาษี VAT = (ค่าไฟฟ้าฐาน + ค่า Ft) x 7/100 เท่านั้น
* ประเภทที่ 1 บ้านอยู่อาศัย
    * 1.1 อัตราปกติ
    ...
    #     - ประเภท 1.2.1: แรงดัน 22 – 33 กิโลโวลท์ Peak = 5.1135, Off Peak = 2.6037. ค่าบริการ 312.24 บาท.
    #     - ประเภท 1.2.2: แรงดันต่ำกว่า 22 กิโลโวลท์ Peak = 5.7982, Off Peak = 2.6369. ค่าบริการ 24.62 บาท.
    #     - ปริมาณการใช้พลังงานไฟฟ้าช่วง Holiday (ฮอ-ลิ-เดย์) คือวันหยุดตามเทศกาล วันหยุดนักขัตฤกษ์ หรือวันหยุดสำคัญที่ทางราชการ บริษัทประกาศให้เป็นวันหยุดหยุดงานหรือหยุดเรียนพร้อมกัน ใช้การคิดแบบ 1.2.2
...
* ใช้สูตรหาร ภาษี VAT = ((ค่าไฟฐาน + ค่าบริการ) + ค่า Ft) x 7/100 เท่านั้น
"""
